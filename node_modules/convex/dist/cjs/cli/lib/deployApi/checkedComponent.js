...
const resource = import_zod.z.union([
  import_zod.z.object({ type: import_zod.z.literal("value"), value: import_zod.z.string() }),
  import_zod.z.object({ type: import_zod.z.literal("function"), path: import_paths.componentFunctionPath })
]);
