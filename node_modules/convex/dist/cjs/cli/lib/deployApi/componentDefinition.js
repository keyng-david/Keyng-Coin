...
const componentArgument = import_zod.z.object({
  type: import_zod.z.literal("value"),
  // Value serialized to JSON.
  value: import_zod.z.string()
});
const componentInstantiation = import_zod.z.object({
  name: import_types.identifier,
  path: import_paths.componentDefinitionPath,
  args: import_zod.z.array(import_zod.z.tuple([import_types.identifier, componentArgument]))
});
...
const componentDefinitionMetadata = import_zod.z.object({
  path: import_paths.componentDefinitionPath,
...
const evaluatedComponentDefinition = import_zod.z.object({
