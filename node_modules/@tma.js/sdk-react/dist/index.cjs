"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const Ot=require("react/jsx-runtime"),l=require("react");var Bs=Object.defineProperty,qs=(e,t,s)=>t in e?Bs(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s,c=(e,t,s)=>qs(e,typeof t!="symbol"?t+"":t,s);function Dt(e,t){let s;const n=()=>{s!==void 0&&t&&t(s),s=void 0};return[()=>s===void 0?s=e(n):s,n]}function ct(e){const t=F(),{count:s}=t;t.unsubscribe(e),s&&!t.count&&Ws()}function Mt(e){return F().subscribe(e),()=>ct(e)}class Os{constructor(t,s={}){this.scope=t,this.options=s}print(t,...s){const n=new Date,i=Intl.DateTimeFormat("en-GB",{hour:"2-digit",minute:"2-digit",second:"2-digit",fractionalSecondDigits:3,timeZone:"UTC"}).format(n),{textColor:r,bgColor:o}=this.options,a="font-weight: bold;padding: 0 5px;border-radius:5px";console[t](`%c${i}%c / %c${this.scope}`,`${a};background-color: lightblue;color:black`,"",`${a};${r?`color:${r};`:""}${o?`background-color:${o}`:""}`,...s)}error(...t){this.print("error",...t)}log(...t){this.print("log",...t)}}const ht=new Os("SDK",{bgColor:"forestgreen",textColor:"white"});let rt=!1;const At=({name:e,payload:t})=>{ht.log("Event received:",t?{name:e,payload:t}:{name:e})};function Nt(e){rt!==e&&(rt=e,e?Mt(At):ct(At))}function Ds(...e){rt&&ht.log(...e)}class I{constructor(){c(this,"listeners",new Map),c(this,"listenersCount",0),c(this,"subscribeListeners",[])}clear(){this.listeners.clear(),this.subscribeListeners=[]}get count(){return this.listenersCount+this.subscribeListeners.length}emit(t,...s){this.subscribeListeners.forEach(n=>n({event:t,args:s})),(this.listeners.get(t)||[]).forEach(([n,i])=>{n(...s),i&&this.off(t,n)})}on(t,s,n){let i=this.listeners.get(t);return i||this.listeners.set(t,i=[]),i.push([s,n]),this.listenersCount+=1,()=>this.off(t,s)}off(t,s){const n=this.listeners.get(t)||[];for(let i=0;i<n.length;i+=1)if(s===n[i][0]){n.splice(i,1),this.listenersCount-=1;return}}subscribe(t){return this.subscribeListeners.push(t),()=>this.unsubscribe(t)}unsubscribe(t){for(let s=0;s<this.subscribeListeners.length;s+=1)if(this.subscribeListeners[s]===t){this.subscribeListeners.splice(s,1);return}}}function ot(e,t,s){return window.addEventListener(e,t,s),()=>window.removeEventListener(e,t,s)}function ut(...e){let t=!1;const s=e.flat(1);return[n=>!t&&s.push(n),()=>{t||(t=!0,s.forEach(n=>n()))},t]}class $ extends Error{constructor(t,s,n){super(s,{cause:n}),this.type=t,Object.setPrototypeOf(this,$.prototype)}}function b(e,t,s){return new $(e,t,s)}const Vt="ERR_METHOD_UNSUPPORTED",Lt="ERR_METHOD_PARAMETER_UNSUPPORTED",$t="ERR_UNKNOWN_ENV",Ht="ERR_INVOKE_CUSTOM_METHOD_RESPONSE",Ut="ERR_TIMED_OUT",Wt="ERR_UNEXPECTED_TYPE",pt="ERR_PARSE",jt="ERR_NAVIGATION_LIST_EMPTY",Gt="ERR_NAVIGATION_CURSOR_INVALID",Ms="ERR_NAVIGATION_ITEM_INVALID",Ns="ERR_SSR_INIT",Kt="ERR_INVALID_PATH_BASE";function B(){return b(Wt,"Value has unexpected type")}class z{constructor(t,s,n){this.parser=t,this.isOptional=s,this.type=n}parse(t){if(!(this.isOptional&&t===void 0))try{return this.parser(t)}catch(s){throw b(pt,`Unable to parse value${this.type?` as ${this.type}`:""}`,s)}}optional(){return this.isOptional=!0,this}}function q(e,t){return()=>new z(e,!1,t)}const R=q(e=>{if(typeof e=="boolean")return e;const t=String(e);if(t==="1"||t==="true")return!0;if(t==="0"||t==="false")return!1;throw B()},"boolean");function zt(e,t){const s={};for(const n in e){const i=e[n];if(!i)continue;let r,o;if(typeof i=="function"||"parse"in i)r=n,o=typeof i=="function"?i:i.parse.bind(i);else{const{type:a}=i;r=i.from||n,o=typeof a=="function"?a:a.parse.bind(a)}try{const a=o(t(r));a!==void 0&&(s[n]=a)}catch(a){throw b(pt,`Unable to parse field "${n}"`,a)}}return s}function Ft(e){let t=e;if(typeof t=="string"&&(t=JSON.parse(t)),typeof t!="object"||t===null||Array.isArray(t))throw B();return t}function y(e,t){return new z(s=>{const n=Ft(s);return zt(e,i=>n[i])},!1,t)}const S=q(e=>{if(typeof e=="number")return e;if(typeof e=="string"){const t=Number(e);if(!Number.isNaN(t))return t}throw B()},"number"),u=q(e=>{if(typeof e=="string"||typeof e=="number")return e.toString();throw B()},"string");function Qt(e){return y({eventType:u(),eventData:t=>t}).parse(e)}function Vs(){["TelegramGameProxy_receiveEvent","TelegramGameProxy","Telegram"].forEach(e=>{delete window[e]})}function at(e,t){window.dispatchEvent(new MessageEvent("message",{data:JSON.stringify({eventType:e,eventData:t}),source:window.parent}))}function Ls(){[["TelegramGameProxy_receiveEvent"],["TelegramGameProxy","receiveEvent"],["Telegram","WebView","receiveEvent"]].forEach(e=>{let t=window;e.forEach((s,n,i)=>{if(n===i.length-1){t[s]=at;return}s in t||(t[s]={}),t=t[s]})})}const $s={clipboard_text_received:y({req_id:u(),data:e=>e===null?e:u().optional().parse(e)}),custom_method_invoked:y({req_id:u(),result:e=>e,error:u().optional()}),popup_closed:{parse(e){return y({button_id:t=>t==null?void 0:u().parse(t)}).parse(e??{})}},viewport_changed:y({height:S(),width:e=>e==null?window.innerWidth:S().parse(e),is_state_stable:R(),is_expanded:R()})};function Hs(){const e=new I,t=new I;t.subscribe(n=>{e.emit("event",{name:n.event,payload:n.args[0]})}),Ls();const[,s]=ut(Vs,ot("resize",()=>{t.emit("viewport_changed",{width:window.innerWidth,height:window.innerHeight,is_state_stable:!0,is_expanded:!0})}),ot("message",n=>{if(n.source!==window.parent)return;let i;try{i=Qt(n.data)}catch{return}const{eventType:r,eventData:o}=i,a=$s[r];try{const h=a?a.parse(o):o;t.emit(...h?[r,h]:[r])}catch(h){ht.error(`An error occurred processing the "${r}" event from the Telegram application.
