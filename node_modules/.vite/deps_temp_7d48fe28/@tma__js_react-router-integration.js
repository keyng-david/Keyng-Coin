...
// node_modules/@tma.js/react-router-integration/dist/index.js
var import_react = __toESM(require_react());
var y = class _y extends Error {
  constructor(e, r, n) {
    super(r, { cause: n }), this.type = e, Object.setPrototypeOf(this, _y.prototype);
  }
};
function _(t, e, r) {
  return new y(t, e, r);
}
var x = "ERR_UNEXPECTED_TYPE";
var $ = "ERR_PARSE";
function h() {
...
function W(t) {
  const e = (0, import_react.useCallback)(() => ({
    ...
    hash: t.hash,
    search: t.search
  }), [t]), [r, n] = (0, import_react.useState)(e), o = (0, import_react.useCallback)((i, a, d) => {
    d || (d = {}), a === void 0 && (a = d.state);
    const g = m(i);
    d.replace ? t.replace(g, a) : t.push(g, a);
  }, [t]), u = (0, import_react.useMemo)(() => ({
    go(i) {
      t.go(i);
    },
    push: o,
  ...
  return (0, import_react.useEffect)(() => t.on("change", () => n(e())), [t, e]), [r, u];
}
export {
  W as useIntegration
};
//# sourceMappingURL=@tma__js_react-router-integration.js.map
