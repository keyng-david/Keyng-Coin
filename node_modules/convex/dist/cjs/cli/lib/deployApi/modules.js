...
const moduleConfig = import_zod.z.object({
  path: import_zod.z.string(),
  source: import_zod.z.string(),
  sourceMap: import_zod.z.optional(import_zod.z.string()),
  environment: moduleEnvironment
});
const nodeDependency = import_zod.z.object({
  name: import_zod.z.string(),
  platform: import_zod.z.string()
});
const udfConfig = import_zod.z.object({
...
const visibility = import_zod.z.union([
  import_zod.z.object({ kind: import_zod.z.literal("public") }),
  import_zod.z.object({ kind: import_zod.z.literal("internal") })
]);
const analyzedFunction = import_zod.z.object({
  name: import_zod.z.string(),
...
const analyzedModule = import_zod.z.object({
