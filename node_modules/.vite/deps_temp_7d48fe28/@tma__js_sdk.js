...
var Ut = (e, t, s) => t in e ? Ot(e, t, { enumerable: true, configurable: true, writable: true, value: s }) : e[t] = s;
...
var zt = "ERR_METHOD_UNSUPPORTED";
var Ft = "ERR_METHOD_PARAMETER_UNSUPPORTED";
var Jt = "ERR_UNKNOWN_ENV";
var Qt = "ERR_INVOKE_CUSTOM_METHOD_RESPONSE";
var Yt = "ERR_TIMED_OUT";
var Zt = "ERR_UNEXPECTED_TYPE";
var ht = "ERR_PARSE";
var Kt = "ERR_NAVIGATION_LIST_EMPTY";
var Xt = "ERR_NAVIGATION_CURSOR_INVALID";
var Ze = "ERR_NAVIGATION_ITEM_INVALID";
var Ke = "ERR_SSR_INIT";
var te = "ERR_INVALID_PATH_BASE";
function E() {
...
var le = class extends K {
  constructor(s, n, r) {
    ...
    c(this, "on", (s2, n2) => s2 === "click" ? w("back_button_pressed", n2) : this.state.on(s2, n2));
...
var Pt = P((e) => e instanceof Date ? e : new Date(y().parse(e) * 1e3), "Date");
function X(e, t) {
  return new V((s) => {
...
var cs = l(
  ({ version: e, postEvent: t }) => new ke(false, e, t)
);
var Ne = class extends Z {
  constructor({ postEvent: s, ...n }) {
    super(n);
    c(this, "postEvent");
    c(this, "on", (s2, n2) => s2 === "click" ? w("main_button_pressed", n2) : this.state.on(s2, n2));
...
var Me = class extends q {
  constructor({ postEvent: s, createRequestId: n, version: r, botInline: i, ...o }) {
    ...
    this.supports = (p) => a(p) ? p !== "switchInlineQuery" || i : false, this.supportsParam = Vt(r, {
...
var us = l(
  ({ postEvent: e, version: t }) => new $e(false, t, e)
);
var Be = class extends q {
  ...
  async open(t) {
    ...
    try {
      ...
      throw this.isOpened = false, r;
    }
  }
};
var ls = l(
  ({ version: e, postEvent: t }) => new Be(false, e, t)
);
var We = class extends K {
  constructor(s, n, r) {
    ...
    c(this, "on", (s2, n2) => s2 === "click" ? w("settings_button_pressed", n2) : this.state.on(s2, n2));
...
function vs(e = true) {
  ...
  return T("iframe_ready", { reload_supported: true }), s;
}
function Es() {
...
async function Ps() {
  if (ft(window))
    return true;
  try {
    return await _({ method: "web_app_request_theme", event: "theme_changed", timeout: 100 }), true;
  } catch {
    return false;
  }
}
...
var Bt = class {
  constructor(t, s, { postEvent: n, hashMode: r = "classic", base: i } = {}) {
    ...
    c(this, "onPopState", ({ state: t2 }) => {
      ...
      t2 === ot ? window.history.forward() : t2 === O && this.back(), t2 === U && this.forward();
    });
