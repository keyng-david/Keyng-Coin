...
var appGeneric = () => createChildComponents("app", []);
var componentGeneric = () => createChildComponents("component", []);
...
function componentGetFunctionName(reference) {
...
async function runUdf(udfType, reference, args) {
